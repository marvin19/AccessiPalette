...
const ContrastBox: React.FC<ContrastBoxProps> = ({leftColor, rightColor, selectedContrast}) => {
    let meetsWCAG;
    ...
    return (
        <div className="contrast-box">
            <FontAwesomeIcon icon ={faArrowLeft} />
                <div className={`inner-contrast-box ${meetsWCAG ? 'passes-border' : 'fails-border'}`}>
