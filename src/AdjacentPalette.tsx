...
const AdjacentPalette: React.FC<AdjacentPaletteProps> = ({
  ...
  return (
    <div className="adjacent-palette">
      ...
      <div className="copy">
        <p>
          This section checks contrast between adjacent colors for clear
          visualization if stacking colors in e.g charts.{' '}
          <strong>Non-adjacent colors are not compared</strong>
        </p>
        <p>
          If you want to keep a color in your color palette, but the neighbor
          color has not enough contrast. Try drag and drop in section 2.
        </p>
      </div>
